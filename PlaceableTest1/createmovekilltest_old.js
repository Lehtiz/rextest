...
function createEntity(entityName, x, y, z){
    ...
    var entity = myScene.CreateEntityRaw(entityId, ["EC_Placeable", "EC_Mesh"]);
...
function checkEntityLocation(entityName, x, y, z){
    var entity = myScene.GetEntityByNameRaw(entityName);
    if(entity != null){
        var xbool = false;
        var ybool = false;
        var zbool = false;
...
function moveEntity(ent, x, y ,z){
    var entity = myScene.GetEntityByNameRaw(ent);
    if(entity != null){
        if(outputEnabled){
